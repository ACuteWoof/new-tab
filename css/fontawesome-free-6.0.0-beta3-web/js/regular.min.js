...
!(function () {
  ...
  function p(C, c) {
    var z = (
      ...
      M = void 0 !== z && z,
      l = d(c);
    "function" != typeof u.hooks.addPack || M
      ? (u.styles[C] = V(V({}, u.styles[C] || {}), l))
      : u.hooks.addPack(C, d(c)),
      "fas" === C && p("fa", c);
  }
  var g = {
    "address-book": [
